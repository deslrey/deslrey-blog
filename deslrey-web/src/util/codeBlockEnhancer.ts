...
export class CodeBlockEnhancer {
  ...
  private addLanguageBadge(pre: HTMLElement, codeEl: HTMLElement) {
    ...
    if (icon) {
      ...
      badge.style.color = '#555'; // fallback 文本颜色
    }
  ...
  private addCopyButton(pre: HTMLElement, codeEl: HTMLElement) {
    ...
    // 默认复制图标
    const copyIcon = `<svg class="icon" viewBox="0 0 1024 1024" width="20" height="20">
    ...
    // 对勾图标
    const successIcon = `<svg class="icon" viewBox="0 0 1024 1024" width="20" height="20">
